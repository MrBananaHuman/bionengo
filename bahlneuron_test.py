...
def main():
	...
	with nengo.Network() as model:
		...
		solver_ens_bio=CustomSolver(P,ens_in,ens_bio,model)
		...
		# nengo.Connection(ens_bio,ens_bio2,solver=solver_ens_bio,synapse=None)
		# nengo.Connection(ens_lif,ens_lif2,synapse=P['tau'])
		# solver_ens_bio2=CustomSolver(P,ens_bio,ens_bio2)
