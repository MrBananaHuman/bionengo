...
def main():
	...
	figure2, ((ax1,ax2,ax3),(ax4,ax5,ax6),(ax7,ax8,ax9),(ax10,ax11,ax12)) = plt.subplots(4,3,sharex=True)
	...
	ax4.set(ylabel='bioneuron2',yticks=([]))
	...
	ax7.set(ylabel='bioneuron3',yticks=([]))
	...
	ax10.set(xlabel='time (s)',ylabel='bioneuron4',yticks=([]))
