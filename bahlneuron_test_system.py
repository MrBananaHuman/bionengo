...
from BahlNeuronSystem import BahlNeuron, CustomSolver
...
def main():
	...
	# ax3.set(ylabel='bioneuron2',yticks=([]))
	...
	# ax5.set(ylabel='bioneuron3',yticks=([]))
	...
	# ax7.set(xlabel='time (s)',ylabel='bioneuron4',yticks=([]))
	# rasterplot(sim.trange(),sim.data[probe_lif_spikes4],ax=ax8,use_eventplot=True)
	# ax8.set(xlabel='time (s)',ylabel='lif4',yticks=([]))
